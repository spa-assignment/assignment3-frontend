...
/**
 * Service grooming view
 */
class ServiceGroomingView {

    /**
     * Constructor
     */
    constructor() {
        this.description = `Book a grooming appointment for your dog. Choose a date and book an appoitment. Attend the appointment. And leave a review when the appointment is completed.`;
    ...
    async getReviews(timeline=null, duration=0.5, stagger=0.3) {
        const response = await AppointmentAPI.getReviews('grooming')
    ...
    render() {
        const template = html`
        <dc-header title="Grooming" user=${JSON.stringify(Auth.currentUser)}></dc-header>
                ...
                <div class="view-service service">
                    ...
                    <div class="service__content">
                        ...
                        <div class="service__book">
                            ...
                            <sl-dialog label="Grooming" class="dialog">
                                <dc-book-appointment type='grooming' .user=${Auth.currentUser}></dc-book-appointment>
                            </sl-dialog>
                        </div>
...
export default new ServiceGroomingView()