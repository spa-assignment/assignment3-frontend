...
/**
 * Service training view
 */
class ServiceTrainingView {

    /**
     * Constructor
     */
    constructor() {
        this.description = `Book a training appointment for your dog. Choose a date and book an appoitment. Attend the appointment. And leave a review when the appointment is completed.`;
    ...
    async getReviews(timeline=null, duration=0.5, stagger=0.3) {
        const response = await AppointmentAPI.getReviews('training')
    ...
    render() {
        const template = html`
        <dc-header title="Training" user=${JSON.stringify(Auth.currentUser)}></dc-header>
        <div class="page-content-container page-content-container--footer">
            <div class="page-content page-content--horizontal-align--center page-content--offset--top-small">
                <div class="view-service service">
                    ...
                    <div class="service__content">
                        ...
                        <div class="service__book">
                            ...
                            <sl-dialog label="Training" class="dialog">
                                <dc-book-appointment type='training' .user=${Auth.currentUser}></dc-book-appointment>
                            </sl-dialog>
                        </div>
                        <div class="service__reviews-container">
                            ...
                            <div class="service__reviews">
                                ...
                                <sl-card class="service__review">
                                    ...
                                    <div slot="footer">
                                        <sl-rating precision=".5" value="${review ? review.stars : 0}" class="service__review-rating"></sl-rating>
                                    </div>
                                </sl-card>
                                `)}
                            </div>
...
export default new ServiceTrainingView()